  ...
  if (screen === "intro") {
    return (
      <div className="min-h-dvh bg-slate-50 text-slate-800 flex flex-col items-center justify-center p-6 relative overflow-hidden">
        <div className="absolute top-[-20%] left-[-10%] size-3/5 rounded-full bg-violet-500/10 blur-[80px] pointer-events-none" />
        <div className="absolute bottom-[-10%] right-[-10%] size-2/5 rounded-full bg-fuchsia-500/10 blur-[80px] pointer-events-none" />
